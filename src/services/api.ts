...
const DEMO_POTHOLES: Pothole[] = [
  ...
  },
  {
    ...
    lat: 43.7301,
    lng: -79.7498,
    detected_at: '2025-11-05T10:15:00Z',
    severity: 0.66,
    estimated_repair_cost_cad: 220,
    status: 'new',
    source: 'dashcam-fleet-110',
    ward: 'Ward 1',
    road_name: 'Queen Street West',
    priority: 'medium',
    description: 'Pothole near retail area',
  },
  {
    id: 'PH-2025-0102',
    lat: 43.7445,
    lng: -79.7356,
    detected_at: '2025-11-07T15:30:00Z',
    severity: 0.53,
  ...
  },
  {
    ...
    lat: 43.6878,
    lng: -79.7612,
    detected_at: '2025-11-02T08:45:00Z',
    severity: 0.74,
    estimated_repair_cost_cad: 295,
    status: 'in_progress',
    source: 'dashcam-fleet-115',
    ward: 'Ward 3',
    road_name: 'Bovaird Drive West',
    priority: 'high',
    description: 'Repair crew working',
  },
  {
    id: 'PH-2025-0104',
    lat: 43.7212,
    lng: -79.7467,
    detected_at: '2025-11-09T12:20:00Z',
    severity: 0.40,
    estimated_repair_cost_cad: 130,
    status: 'completed',
    source: 'iot-camera-kennedy-rd',
    ...
    road_name: 'Kennedy Road South',
    priority: 'low',
    description: 'Repaired November 7, 2025',
  },
  {
    id: 'PH-2025-0105',
    lat: 43.7189,
    lng: -79.7178,
    detected_at: '2025-11-04T16:40:00Z',
    severity: 0.82,
    estimated_repair_cost_cad: 345,
    status: 'new',
    source: 'dashcam-fleet-120',
    ward: 'Ward 4',
    road_name: 'Chinguacousy Road North',
    priority: 'high',
  ...
  },
  {
    ...
    lat: 43.7323,
    lng: -79.7545,
    detected_at: '2025-11-11T09:10:00Z',
    severity: 0.58,
  ...
  },
  {
    ...
    lat: 43.7456,
    lng: -79.7201,
    detected_at: '2025-11-03T14:25:00Z',
    severity: 0.45,
    estimated_repair_cost_cad: 150,
    status: 'completed',
    source: 'dashcam-fleet-125',
    ward: 'Ward 5',
    road_name: 'McLaughlin Road South',
    priority: 'low',
    description: 'Repaired November 2, 2025',
  },
  {
    id: 'PH-2025-0108',
    lat: 43.6934,
    lng: -79.7489,
    detected_at: '2025-11-10T11:50:00Z',
    severity: 0.89,
    ...
    road_name: 'Steeles Avenue West',
    priority: 'critical',
    description: 'Critical pothole near major junction',
  },
  {
    id: 'PH-2025-0109',
    lat: 43.7578,
    lng: -79.7723,
    detected_at: '2025-11-06T13:35:00Z',
    severity: 0.61,
    estimated_repair_cost_cad: 205,
    status: 'in_progress',
    source: 'dashcam-fleet-130',
    ward: 'Ward 2',
    road_name: 'Sandalwood Parkway East',
    priority: 'medium',
    description: 'Repair underway',
  },
  {
    ...
    lat: 43.7101,
    lng: -79.7301,
    detected_at: '2025-11-08T07:20:00Z',
    severity: 0.36,
    estimated_repair_cost_cad: 120,
    status: 'scheduled',
    source: 'iot-camera-bramalea',
    ...
    road_name: 'Bramalea Road South',
    priority: 'low',
    description: 'Minor repair scheduled',
  },
  {
    id: 'PH-2025-0111',
    lat: 43.7498,
    lng: -79.7889,
    detected_at: '2025-11-01T18:45:00Z',
    severity: 0.85,
    estimated_repair_cost_cad: 380,
    status: 'completed',
    source: 'dashcam-fleet-135',
    ward: 'Ward 6',
    road_name: 'Airport Road South',
    priority: 'high',
    description: 'Repaired October 28, 2025',
  },
  {
    ...
    severity: 0.49,
    estimated_repair_cost_cad: 165,
    status: 'new',
    source: 'iot-camera-queen-st',
    ward: 'Ward 1',
    road_name: 'Queen Street East',
    priority: 'medium',
    description: 'Moderate pothole detected',
  },
  {
    id: 'PH-2025-0113',
    lat: 43.6845,
    lng: -79.7745,
    detected_at: '2025-11-05T16:15:00Z',
    severity: 0.77,
    estimated_repair_cost_cad: 310,
    status: 'in_progress',
    source: 'dashcam-fleet-140',
    ward: 'Ward 7',
    road_name: 'Countryside Drive West',
    priority: 'high',
    description: 'Repair in progress',
  },
  {
    ...
    lat: 43.7689,
    lng: -79.7456,
    detected_at: '2025-11-09T14:55:00Z',
    severity: 0.42,
    estimated_repair_cost_cad: 140,
    status: 'scheduled',
    source: 'iot-camera-mayfield',
  ...
  },
  {
    ...
    lat: 43.7367,
    lng: -79.7112,
    detected_at: '2025-11-07T08:40:00Z',
    severity: 0.70,
    estimated_repair_cost_cad: 280,
    status: 'completed',
    source: 'dashcam-fleet-145',
    ward: 'Ward 9',
    road_name: 'Torbram Road North',
    priority: 'medium',
    description: 'Repaired October 25, 2025',
  },
  {
    ...
    lat: 43.6967,
    lng: -79.7356,
    detected_at: '2025-11-02T19:20:00Z',
    severity: 0.55,
    estimated_repair_cost_cad: 185,
    status: 'new',
    source: 'iot-camera-clark',
  ...
  },
  {
    ...
    lat: 43.7534,
    lng: -79.7267,
    detected_at: '2025-11-11T11:05:00Z',
    severity: 0.81,
    estimated_repair_cost_cad: 340,
    status: 'in_progress',
    source: 'dashcam-fleet-150',
    ward: 'Ward 5',
    road_name: 'Ray Lawson Boulevard East',
    priority: 'high',
    description: 'Repair crew on site',
  },
  {
    ...
    lat: 43.7145,
    lng: -79.7867,
    detected_at: '2025-11-04T13:50:00Z',
    severity: 0.38,
    estimated_repair_cost_cad: 125,
    status: 'scheduled',
    source: 'iot-camera-goreway',
    ward: 'Ward 6',
    road_name: 'Goreway Drive North',
    priority: 'low',
    description: 'Minor issue scheduled',
  },
  {
    id: 'PH-2025-0119',
    lat: 43.6789,
    lng: -79.7534,
    detected_at: '2025-11-08T17:25:00Z',
    severity: 0.68,
    estimated_repair_cost_cad: 255,
    status: 'completed',
    source: 'dashcam-fleet-155',
    ward: 'Ward 7',
    road_name: 'Williams Parkway East',
    priority: 'medium',
    description: 'Repaired October 20, 2025',
  },
  {
    ...
    lat: 43.7701,
    lng: -79.7623,
    detected_at: '2025-11-06T09:40:00Z',
    severity: 0.92,
  ...
  },
  {
    ...
    lat: 43.7289,
    lng: -79.7489,
    detected_at: '2025-11-10T15:15:00Z',
    severity: 0.51,
    estimated_repair_cost_cad: 170,
    status: 'in_progress',
    source: 'dashcam-fleet-160',
    ward: 'Ward 1',
    road_name: 'Queen Street West',
    priority: 'medium',
    description: 'Repair ongoing',
  },
  {
    id: 'PH-2025-0122',
    lat: 43.7490,
    lng: -79.7323,
    detected_at: '2025-11-03T12:30:00Z',
    severity: 0.64,
    ...
    road_name: 'Main Street North',
    priority: 'medium',
    description: 'Scheduled for next cycle',
  },
  {
    id: 'PH-2025-0123',
    lat: 43.6912,
    lng: -79.7589,
    detected_at: '2025-11-07T10:45:00Z',
    severity: 0.47,
    estimated_repair_cost_cad: 155,
    status: 'completed',
    source: 'dashcam-fleet-165',
    ward: 'Ward 3',
    road_name: 'Bovaird Drive East',
    priority: 'low',
    description: 'Repaired October 15, 2025',
  },
  {
    ...
    lat: 43.7201,
    lng: -79.7434,
    detected_at: '2025-11-12T14:20:00Z',
    severity: 0.79,
    estimated_repair_cost_cad: 315,
    status: 'new',
    source: 'iot-camera-kennedy-rd',
  ...
  },
  {
    ...
    lat: 43.7234,
    lng: -79.7156,
    detected_at: '2025-11-05T08:35:00Z',
    severity: 0.44,
    estimated_repair_cost_cad: 145,
    status: 'in_progress',
    source: 'dashcam-fleet-170',
    ward: 'Ward 4',
    road_name: 'Chinguacousy Road',
    priority: 'low',
    description: 'Minor repair underway',
  },
  {
    id: 'PH-2025-0126',
    lat: 43.7345,
    lng: -79.7523,
    detected_at: '2025-11-09T16:50:00Z',
    severity: 0.86,
  ...
  },
  {
    ...
    lat: 43.7467,
    lng: -79.7189,
    detected_at: '2025-11-02T11:25:00Z',
    severity: 0.50,
    estimated_repair_cost_cad: 165,
    status: 'completed',
    source: 'dashcam-fleet-175',
    ward: 'Ward 5',
    road_name: 'McLaughlin Road',
    priority: 'medium',
    description: 'Repaired October 10, 2025',
  },
  {
    ...
    lat: 43.6978,
    lng: -79.7478,
    detected_at: '2025-11-11T13:40:00Z',
    severity: 0.73,
    ...
    road_name: 'Steeles Avenue East',
    priority: 'high',
    description: 'Pothole near business district',
  },
  {
    id: 'PH-2025-0129',
    lat: 43.7612,
    lng: -79.7678,
    detected_at: '2025-11-04T15:05:00Z',
    severity: 0.59,
    estimated_repair_cost_cad: 210,
    status: 'in_progress',
    source: 'dashcam-fleet-180',
    ward: 'Ward 2',
    road_name: 'Sandalwood Parkway',
    priority: 'medium',
    description: 'Repair work ongoing',
  },
  {
    ...
    lat: 43.7112,
    lng: -79.7289,
    detected_at: '2025-11-08T09:55:00Z',
    severity: 0.39,
    estimated_repair_cost_cad: 130,
    status: 'scheduled',
    source: 'iot-camera-bramalea',
    ...
    road_name: 'Bramalea Road',
    priority: 'low',
    description: 'Small repair scheduled',
  },
  {
    id: 'PH-2025-0131',
    lat: 43.7523,
    lng: -79.7845,
    detected_at: '2025-11-06T12:10:00Z',
    severity: 0.88,
    estimated_repair_cost_cad: 420,
    status: 'completed',
    source: 'dashcam-fleet-185',
    ward: 'Ward 6',
    road_name: 'Airport Road',
    priority: 'critical',
    description: 'Repaired October 5, 2025',
  },
  {
    ...
    road_name: 'Queen Street East',
    priority: 'medium',
    description: 'Pothole near transit stop',
  },
  {
    id: 'PH-2025-0133',
    lat: 43.6823,
    lng: -79.7712,
    detected_at: '2025-11-01T14:45:00Z',
    severity: 0.75,
    estimated_repair_cost_cad: 305,
    status: 'in_progress',
    source: 'dashcam-fleet-190',
    ward: 'Ward 7',
    road_name: 'Countryside Drive',
    priority: 'high',
    description: 'Repair crew working',
  },
  {
    ...
    lat: 43.7723,
    lng: -79.7412,
    detected_at: '2025-11-10T17:20:00Z',
    severity: 0.41,
    estimated_repair_cost_cad: 135,
    status: 'scheduled',
    source: 'iot-camera-mayfield',
    ward: 'Ward 8',
    road_name: 'Mayfield Road',
    priority: 'low',
    description: 'Minor defect scheduled',
  },
  {
    id: 'PH-2025-0135',
    lat: 43.7389,
    lng: -79.7098,
    detected_at: '2025-11-03T10:35:00Z',
    severity: 0.76,
    estimated_repair_cost_cad: 295,
    status: 'completed',
    source: 'dashcam-fleet-195',
    ward: 'Ward 9',
    road_name: 'Torbram Road',
    priority: 'high',
    description: 'Repaired September 30, 2025',
  },
  {
    ...
    lat: 43.6956,
    lng: -79.7378,
    detected_at: '2025-11-07T16:50:00Z',
    severity: 0.56,
  ...
  },
  {
    ...
    lat: 43.7556,
    lng: -79.7245,
    detected_at: '2025-11-05T13:15:00Z',
    severity: 0.83,
    estimated_repair_cost_cad: 350,
    status: 'in_progress',
    source: 'dashcam-fleet-200',
    ward: 'Ward 5',
    road_name: 'Ray Lawson Boulevard',
    priority: 'high',
    description: 'Large repair ongoing',
  },
  {
    id: 'PH-2025-0138',
    lat: 43.7123,
    lng: -79.7823,
    detected_at: '2025-11-12T08:40:00Z',
    severity: 0.37,
    estimated_repair_cost_cad: 120,
    status: 'scheduled',
    source: 'iot-camera-goreway',
  ...
  },
  {
    ...
    lat: 43.6812,
    lng: -79.7501,
    detected_at: '2025-11-09T15:25:00Z',
    severity: 0.65,
    estimated_repair_cost_cad: 245,
    status: 'completed',
    source: 'dashcam-fleet-205',
    ward: 'Ward 7',
    road_name: 'Williams Parkway',
    priority: 'medium',
    description: 'Repaired September 25, 2025',
  },
  {
    ...
    lat: 43.7667,
    lng: -79.7589,
    detected_at: '2025-11-02T18:50:00Z',
    severity: 0.94,
  ...
  },
  {
    ...
    lat: 43.7312,
    lng: -79.7467,
    detected_at: '2025-11-11T12:05:00Z',
    severity: 0.52,
    estimated_repair_cost_cad: 175,
    status: 'in_progress',
    source: 'dashcam-fleet-210',
    ward: 'Ward 1',
    road_name: 'Queen Street West',
    priority: 'medium',
    description: 'Repair underway',
  },
  {
    ...
    lat: 43.7478,
    lng: -79.7312,
    detected_at: '2025-11-04T09:30:00Z',
    severity: 0.69,
    estimated_repair_cost_cad: 270,
    status: 'scheduled',
    source: 'iot-camera-main-st',
  ...
  },
  {
    ...
    lat: 43.6889,
    lng: -79.7623,
    detected_at: '2025-11-08T11:45:00Z',
    severity: 0.43,
    estimated_repair_cost_cad: 140,
    status: 'completed',
    source: 'dashcam-fleet-215',
    ward: 'Ward 3',
    road_name: 'Bovaird Drive West',
    priority: 'low',
    description: 'Repaired September 20, 2025',
  },
  {
    ...
    lat: 43.7245,
    lng: -79.7445,
    detected_at: '2025-11-06T14:10:00Z',
    severity: 0.80,
    estimated_repair_cost_cad: 325,
    status: 'new',
    source: 'iot-camera-kennedy-rd',
    ...
    road_name: 'Kennedy Road North',
    priority: 'high',
    description: 'Large pothole near plaza',
  },
  {
    id: 'PH-2025-0145',
    lat: 43.7167,
    lng: -79.7123,
    detected_at: '2025-11-10T10:25:00Z',
    severity: 0.48,
    estimated_repair_cost_cad: 160,
    status: 'in_progress',
    source: 'dashcam-fleet-220',
    ward: 'Ward 4',
    road_name: 'Chinguacousy Road North',
    priority: 'medium',
    description: 'Repair ongoing',
  },
  {
    ...
    lat: 43.7334,
    lng: -79.7512,
    detected_at: '2025-11-01T16:40:00Z',
    severity: 0.87,
    estimated_repair_cost_cad: 385,
    status: 'scheduled',
    source: 'iot-camera-hurontario',
    ward: 'Ward 1',
    road_name: 'Hurontario Street North',
    priority: 'critical',
    description: 'Critical repair scheduled',
  },
  {
    id: 'PH-2025-0147',
    lat: 43.7501,
    lng: -79.7178,
    detected_at: '2025-11-12T13:55:00Z',
    severity: 0.46,
    estimated_repair_cost_cad: 150,
    status: 'completed',
    source: 'dashcam-fleet-225',
    ward: 'Ward 5',
    road_name: 'McLaughlin Road South',
    priority: 'low',
    description: 'Repaired September 15, 2025',
  },
  {
    ...
    lat: 43.7001,
    lng: -79.7456,
    detected_at: '2025-11-05T12:20:00Z',
    severity: 0.72,
    ...
    road_name: 'Steeles Avenue West',
    priority: 'high',
    description: 'Pothole near warehouse',
  },
  {
    id: 'PH-2025-0149',
    lat: 43.7589,
    lng: -79.7701,
    detected_at: '2025-11-09T17:35:00Z',
    severity: 0.60,
    estimated_repair_cost_cad: 215,
    status: 'in_progress',
    source: 'dashcam-fleet-230',
    ward: 'Ward 2',
    road_name: 'Sandalwood Parkway East',
    priority: 'medium',
    description: 'Repair work active',
  },
  {
    id: 'PH-2025-0150',
    lat: 43.7089,
    lng: -79.7267,
    detected_at: '2025-11-03T08:50:00Z',
    severity: 0.35,
    estimated_repair_cost_cad: 115,
    status: 'scheduled',
    source: 'iot-camera-bramalea',
    ward: 'Ward 4',
    road_name: 'Bramalea Road South',
    priority: 'low',
    description: 'Small defect scheduled',
  },
];
